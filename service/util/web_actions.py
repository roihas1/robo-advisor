from our_core.models import QuestionnaireA
...
from users.models import InvestorUser, CustomUser
...
def create_portfolio_instance(user: CustomUser):
    ...
    from our_core.models import QuestionnaireB
...
def send_email(subject, message, recipient_list, attachment_path=None):
    ...
    msg.send()
# def create_portfolio_and_get_data(answers_sum, stocks_collections_number, questionnaire_a):
#     return None